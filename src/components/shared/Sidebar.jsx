        ...
        <div className={`bg-[#1F1D2B] fixed lg:left-0 top-0 w-28 h-full flex flex-col justify-between py-6 rounded-tr-xl rounded-br-xl z-50 transition-all ${showMenu ? "left-0" : "-left-full"}`}>
            <div>
                <ul className="pl-4">
                    ...
                    <li className="bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl group-first-of-type:">
                        <a href="#" className="bg-[#EC7C6A] text-center p-4 flex justify-center rounded-xl text-white">
